---
name: music-server
description: Generate audio with the portable Music Server.
version: "1.0"
author: aivrar
license: MIT
platforms: [windows]
metadata:
  hermes:
    tags: [music, audio, generation, ai, gpu]
    category: extensions
---
...
Use this skill when the user wants to install or manage the portable Music Server, load its models, or generate music, songs, or sound effects locally.
